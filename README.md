...
different providers. By default, Kubernetes manages DNS records internally, but
...
> [Upgrading from previous versions](https://mconfalonieri.github.io/external-dns-hetzner-webhook/v1.0.2/upgrading/)
> section.
