...
// NewLabelsFromString constructs endpoint labels from a provided format string
...
// Serialize transforms endpoint labels into a external-dns recognizable format string
